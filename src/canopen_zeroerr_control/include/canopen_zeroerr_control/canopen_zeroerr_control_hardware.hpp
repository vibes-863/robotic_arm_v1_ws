...
#ifndef CANOPEN_ZEROERR_CONTROL__ROBOT_SYSTEM_HPP_
#define CANOPEN_ZEROERR_CONTROL__ROBOT_SYSTEM_HPP_
...
#include "canopen_zeroerr_control/cia402_data.hpp"
#include "canopen_zeroerr_control/visibility_control.h"
...
namespace canopen_zeroerr_control
{
class CanopenZeroerrControlHardware : public hardware_interface::SystemInterface
{
public:
  CANOPEN_ZEROERR_CONTROL__VISIBILITY_PUBLIC
  CanopenZeroerrControlHardware() : hardware_interface::SystemInterface() {}
  CANOPEN_ZEROERR_CONTROL__VISIBILITY_PUBLIC
  ~CanopenZeroerrControlHardware() = default;
...
protected:
  ...
  rclcpp::Logger canopen_zeroerr_control_hardware_logger = rclcpp::get_logger("canopen_zeroerr_control_hardware");
