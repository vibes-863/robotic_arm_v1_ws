...
#ifndef CANOPEN_ZEROERR_CONTROL__CIA402_DATA_HPP_
#define CANOPEN_ZEROERR_CONTROL__CIA402_DATA_HPP_
...
#include "canopen_zeroerr_control/helpers.hpp"
  ...
  void write_target()
  {
    ...
    switch (mode)
    {
      ...
      case MotorBase::Profiled_Torque:
        ...
        break;
      default:
        RCLCPP_INFO(rclcpp::get_logger("canopen_zeroerr_control_hardware_interface"), "Mode not supported");
    }
  }
